...
export const getStaticProps = async ({context}) => {
  const data = await client.get({ endpoint: "blogs", queries: { offset: context?.params?.page || 0, limit: 100 } });
  console.log(Number(context?.params.p));
